...
public class ExpressImportWizardPage extends WizardPage implements IWizardPage, Listener {
  ...
  public void createControl(Composite parent) {
    ...
    if (destinations != null) {
      ...
      for (String destination : destinations) {
        if (destination.endsWith(ExpressImportUtil.DEFAULT_EXTENSION)) {
  ...
  private void saveDialogSettings() {
    ...
    if (destinations.contains(path)) {
      ...
      getDialogSettings().put(ExpressImportUtil.DESTINATION_KEY, destinations.toArray(String[]::new));
    } else if (lowerCasePath.endsWith(ExpressImportUtil.DEFAULT_EXTENSION)) {
  ...
  private void handleDestinationBrowseButtonPressed() {
    ...
    dialog.setFilterExtensions(ExpressImportUtil.IMPORT_TYPE);
